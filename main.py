...
def main():
    ...
    while True:
        ...
        print(Fore.RED + "\n[TIME]" + Style.RESET_ALL + " Dump fini veuillez patienter pour le prochain (5min) ...\n")
        time.sleep(300)
